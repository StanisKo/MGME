...
/*
ACTIONS - These are serializable (hence replayable)
descriptions of state transitions

They do not themselves have any side-effects;
they just describe something that is going to happen

Use @typeName and isActionType for type detection
that works even after serialization/deserialization
*/
